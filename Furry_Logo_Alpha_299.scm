...
(script-fu-register "script-fu-furry-logo"
  "Furry LOGO"
...
(script-fu-menu-register "script-fu-furry-logo" "<Image>/Script-Fu/Logos")


(define (script-fu-furry image layer
                               fur-color
							   tint-color
							   motle-color
							   motle-size
...
(script-fu-register "script-fu-furry"        		    
  "Furry ALPHA"
...
(script-fu-menu-register "script-fu-furry" "<Image>/Script-Fu/Alpha-to-Logo")
