...
(define (script-fu-scanner-logo-300 text size font text-color use-gradient? text-gradient cut-color bg-color)
...
(script-fu-register "script-fu-scanner-logo-300"
		    "Scanner Logo 300"
