...
(gimp-layer-new ln1 ln5 ln2 ln3 ln4 ln6 ln7)))
  ...
  (script-fu-register
            "script-fu-pijama-logo300"                        ;function name
            "Pijama logo 300"                                  ;menu label
            ...
            SF-FONT        "Font"          "QTSchoolCentury Bold"    ;a font variable
...
SF-COLOR       "Color"         '(141 105 224)     ;color variable							
  ...
  (script-fu-menu-register "script-fu-pijama-logo300" "<Image>/File/Create/Logos")
  (define (script-fu-pijama-logo300 inText inFont inFontSize inTextColor inTextColor2 Third-type inTextColor3
					justification
					letter-spacing
					line-spacing
					grow-text
   ...
   (gimp-image-insert-layer theImage bord1Layer 0 1) 
   	 (define bord2Layer (car(gimp-layer-new-ng theImage 10 10 RGBA-IMAGE _"Bord 2 Layer" 100 LAYER-MODE-NORMAL-LEGACY)) )
