...
; you can test script-fu-ya-chrome-logo-29919 with console messages
...
;
(define (script-fu-ya-chrome-logo-29919 
                                      text
									  justify
									  letter-spacing
									  line-spacing
...
;;;;start of script;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	(script-fu-ya-chrome-29919 image text-layer
					metal
					colorize
					metal-finish
					depth
...
(script-fu-register "script-fu-ya-chrome-logo-29919"
  "ya Chrome Logo 2.99.19"
...
(script-fu-menu-register "script-fu-ya-chrome-logo-29919" "<Image>/Script-Fu/Logos/")
;
 (define (script-fu-ya-chrome-29919 image drawable
                                       metal
				       colorize
				       metal-finish
				       depth
...
(script-fu-register "script-fu-ya-chrome-29919"        		    
  "ya Chrome 2.99.19 Alpha"
...
(script-fu-menu-register "script-fu-ya-chrome-29919" "<Image>/Script-Fu/Alpha-to-Logo/")
