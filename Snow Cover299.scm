...
;
(define (script-fu-snow-cover299-alpha image layer
                               depth
							   conserve
							   )
...
(script-fu-register "script-fu-snow-cover299-alpha"        		    
  "Snow Cover Alpha 299..."
...
(script-fu-menu-register "script-fu-snow-cover299-alpha" "<Image>/Script-Fu/Alpha-to-Logo")

(define (script-fu-snow-cover299-logo 
                            text 
                            color 
                            font-in 
                            font-size
...
(script-fu-register "script-fu-snow-cover299-logo"
  "Snow Cover Logo 299..."
...
(script-fu-menu-register "script-fu-snow-cover299-logo" "<Image>/Script-Fu/Logos" )
