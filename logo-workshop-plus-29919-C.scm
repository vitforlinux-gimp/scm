...
(define (apply-logo-workshop-plus-299c19 img
                             logo-layer
                             fill-style
                             logo-color
			     logo-pattern
...
) ; return (from apply-logo-workshop-plus-299c19) 
;
;
...
;
(define (script-fu-logo-workshop-plus-299c-alpha img
                                       logo-layer
                                       fill-style
                                       logo-color
				       logo-pattern
...
;
    (apply-logo-workshop-plus-299c19 img logo-layer fill-style logo-color logo-pattern logo-gradient logo-gradient-rvs bevel-amt stroke-type stroke-color  stroke-pattern stroke-gradient stroke-gradient-rvs stroke-width shadow-color shadowx shadowy shadow-opacity effect-style effect-pattern effect-depth alpha2logo)
...
;
(script-fu-register "script-fu-logo-workshop-plus-299c-alpha"
                    _"_Logo Workshop PLUS ALPHA 299 C..."
...
(script-fu-menu-register "script-fu-logo-workshop-plus-299c-alpha"
                         "<Image>/Filters/Alpha to Logo")

;
; Define logo effect text procedure
;
(define (script-fu-logo-workshop-plus-299c text
                                 size
                                 font 
								 justification
                                 letter-spacing
...
; Register the script
;    
(script-fu-register "script-fu-logo-workshop-plus-299c"
                    _"_Logo Workshop PLUS LOGO 299 C..."
...
(script-fu-menu-register "script-fu-logo-workshop-plus-299c"
