...
; calque fond *******************************************************************************		
	...
	(set! calque_fond (car (gimp-layer-new img (+ width height) (+ width height) 1 "Fond" 100 0)))
...
; effet****************
	...
	(plug-in-gauss 1 img calque_texte (* Taille_Police (/ Flou 300)) (* Taille_Police (/ Flou 300)) 0)	
...
; calque Texte 2 *******************************************************************************	
	...
	(set! calque_texte_2 (car (gimp-layer-new img (+ width height) (+ width height) 1 "Texte noir" 100 0)))
...
; calque stripes *****************************************************************************	
	...
	; créer un nouveau calque + grand pour pouvoir pivoter en couvrant le texte
	(set! stripes (car (gimp-layer-new img (+ width height) (+ width height) 1 "Stripes" 100 0)))
	...
	(if 
		(= shadow TRUE)		
			(begin
				...
				; flou
				(plug-in-gauss-iir2 1 img ombre (/ Taille_Police 8) (/ Taille_Police 8) )
...
(script-fu-register "script-fu-sweet-candy-text299mod"
	"Sweet candy text 299 mod..."
...
(script-fu-menu-register "script-fu-sweet-candy-text299mod" "<Image>/File/Create/Logos/" )
; FIN du script
