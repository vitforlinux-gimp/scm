...
(define (apply-logo-workshop-plus-299a16 img
                             logo-layer
                             fill-style
                             logo-color
			     logo-pattern
...
;
	...
	(gimp-context-set-foreground logo-color) 	    (gimp-drawable-edit-fill fill-layer FILL-FOREGROUND)
	  ...
	  (gimp-context-set-gradient logo-gradient)   
(gimp-drawable-edit-fill fill-layer FILL-FOREGROUND)
...
) ; return (from apply-logo-workshop-plus-299a16) 
;
;
...
;
(define (script-fu-logo-workshop-plus-299a-alpha img
                                       logo-layer
                                       fill-style
                                       logo-color
				       logo-pattern
...
;
    (apply-logo-workshop-plus-299a16 img logo-layer fill-style logo-color logo-pattern logo-gradient bevel-amt stroke-type stroke-color  stroke-pattern stroke-gradient stroke-width shadow-color shadowx shadowy shadow-opacity effect-style effect-pattern effect-depth alpha2logo)
...
;
(script-fu-register "script-fu-logo-workshop-plus-299a-alpha"
                    _"_Logo Workshop PLUS ALPHA 299 A..."
...
(script-fu-menu-register "script-fu-logo-workshop-plus-299a-alpha"
                         "<Image>/Filters/Alpha to Logo")

;
; Define logo effect text procedure
;
(define (script-fu-logo-workshop-plus-299a text
                                 size
                                 font 
								 justification
                                 letter-spacing
...
; Register the script
;    
(script-fu-register "script-fu-logo-workshop-plus-299a"
                    _"_Logo Workshop PLUS LOGO 299 A..."
...
(script-fu-menu-register "script-fu-logo-workshop-plus-299a"
