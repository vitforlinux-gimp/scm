...
(define list-fill-ppf-dir '("Color" "Pattern" "Gradient" "None" "Aluminium Brushed" "Aluminium Brushed Light" "Blue Jeans" "Washed Jeans" "Dark Jeans" "Carbon fiber"  "Bovination" "Camouflage 1" "Camouflage 2" "Plasma"  "Patchwork" "Pizza" "Emap gradient" "Pijama gradient Horiz" "Pijama gradient 45" "Pijama gradient Vert" "Vit Wood" "Steampunk Brass" "Steampunk Color" "Grunge Green" "Grunge Color" "Stripes Horiz" "Stripes 45" "Stripes Vert"))
(define list-effect-ppf-dir '("None" "Blur" "Oilify" "Cubism""Bump with pattern" "Desaturate & Chrome"  "Desaturate+Chrome+Color LIGHTEN ONLY" "Desaturate+Chrome+Color MULTILPLY"  "Desaturate+Chrome+Color OVERLAY" "Desaturate+Color  LIGHTEN ONLY" "Desaturate+Color MULTILPLY" "Desaturate+Color OVERLAY" "Glitter"))
...
(define 
	(
		script-fu-plastic-logo300-alpha
		img
		text-layer
		border-color
		 border-size
...
(script-fu-register 	
	"script-fu-plastic-logo300-alpha"
	"Polished Plastic Fun 300 ALPHA..."
	"Create a polished plastic logo alpha object"
	"Denis Bodor <lefinnois(a t )lefinnois.net>"
	"Denis Bodor"
	"03/31/2005"
	""
	SF-IMAGE		"Image"			0
...
(script-fu-register
	...
	SF-ADJUSTMENT _"Outline"          '(0 0 20 1 10 0 0)
		SF-OPTION "Text deformation" '("None" "Electrized" "Rounded")
