...
; Rakugaki-plus299.scm Gimp 2.10.34 3.0rc2
; You draw Ver1.0」 
...
(begin
     (if (= ctype 0)  (gimp-context-set-foreground random-color))
      (if  (defined? 'gimp-context-enable-dynamics) (gimp-context-enable-dynamics TRUE))
      (if (= ctype 1) (begin (gimp-context-set-foreground color) (gimp-context-set-dynamics-name "Pressure Opacity")))
       (if (= ctype 2) (gimp-context-set-dynamics-name "Random Color"))))
...
(script-fu-register "script-fu-rakugaki-plus300"
_"Rakugaki-PLUS (Graffiti) 300..."
...
(script-fu-menu-register "script-fu-rakugaki-plus300"
