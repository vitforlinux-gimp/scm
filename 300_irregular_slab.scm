...
;
; Update/fix for Gimp 2.10.32 and 3.0rc1 vitforlinux
...
(script-fu-register
    "script-fu-chris-slab300text"
    "Irregular Slab 300 Logo"
...
(script-fu-menu-register "script-fu-chris-slab300text" "<Image>/Script-Fu/Logos/")
