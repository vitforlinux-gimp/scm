...
; Début du script-fu script-fu-Glossy-Metal-3D-Text-By-Monsoonami-new_Gimp_2_8.scm
;
...
(define (
				script-fu-Glossy-Metal-3D-Text-By-Monsoonami-new
				Couleur_fond
				Texte
				Police
				Couleur_encre
...
(script-fu-register
	"script-fu-Glossy-Metal-3D-Text-By-Monsoonami-new"
	"Glossy Metal 3D Text By Monsoonami new"
	...
	SF-STRING "Texte / Text" "Gimp 2.99.8"
...
(script-fu-menu-register "script-fu-Glossy-Metal-3D-Text-By-Monsoonami-new"
