...
;;;;begin the script
	(script-fu-emap300-alpha image text-layer
                               map-type    ; Environment Map Type
                               paint-mode    ; Selected Paint Mode For Use WIth Blend Plug-in
                               blend-direction    ; Blend Direction
                               blend-shape    ; Blend Shape
...
(script-fu-register "script-fu-emap300-logo"
  "Emap Logo 300"
...
(script-fu-menu-register "script-fu-emap300-logo" "<Image>/Script-Fu/Logos")

(define (script-fu-emap300-alpha image layer
                               map-type    ; Environment Map Type
                               paint-mode    ; Selected Paint Mode For Use WIth Blend Plug-in
                               blend-direction    ; Blend Direction
                               blend-shape    ; Blend Shape
...
(cond ((not (defined? 'gimp-drawable-filter-new))
...
(script-fu-register "script-fu-emap300-alpha"        		    
  "Emap Alpha 300"
  "Instructions"
  "Graechan"
  "Graechan - http://gimpchat.com"
...
(script-fu-menu-register "script-fu-emap300-alpha" "<Image>/Script-Fu/Alpha-to-Logo")
