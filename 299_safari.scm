...
(define (script-fu-safari-logo-299-alpha image drawable size type relief grad-type gradient flou flou-r elevation depth conserv trans? bgcolor scolor sblur soff)
	(let* (
		...
		(apply-safari-logo-299 image drawable size type relief grad-type gradient flou flou-r elevation depth conserv trans? bgcolor scolor sblur soff)
...
(script-fu-register "script-fu-safari-logo-299-alpha"
		"Safari 299 ALPHA"
...
(script-fu-menu-register "script-fu-safari-logo-299-alpha" "<Image>/Script-Fu/Alpha-to-Logo/")


(define (script-fu-safari-logo-299 text size font justify type relief grad-type gradient flou flou-r elevation depth conserv trans? bgcolor scolor sblur soff)
...
;;ÉTÉCÉYí≤êÆ
    ...
    (script-fu-safari-logo-299-alpha img text-layer size type relief grad-type gradient flou flou-r elevation depth conserv trans? bgcolor scolor sblur soff)
...
(script-fu-register "script-fu-safari-logo-299"
		    "Safari 299 LOGO"
		    "safari-logo-299"
		    "Apply by Kiki"
		    "Giants"
...
(script-fu-menu-register "script-fu-safari-logo-299" "<Image>/Script-Fu/Logos/")
