...
(gimp-drawable-edit-stroke-selection theBlur2Layer))
    ...
    (if (= outype 2)  (begin (if  (defined? 'gimp-context-enable-dynamics) (gimp-context-enable-dynamics TRUE))(gimp-context-set-dynamics "Random Color")))
    (if (= outype 3)  (begin (if  (defined? 'gimp-context-enable-dynamics) (gimp-context-enable-dynamics TRUE))(gimp-context-set-dynamics "Dynamics Random")))
    (if (= outype 4)  (begin (if  (defined? 'gimp-context-enable-dynamics) (gimp-context-enable-dynamics TRUE))(gimp-context-set-dynamics "Confetti")))

    ;(gimp-context-set-brush "Circle (19)")
		 (if (= (string->number (substring (car(gimp-version)) 0 3)) 2.10)
        (gimp-context-set-brush (car  brush)) 
  (gimp-context-set-brush   brush)	)
  (if (> outype 0) (gimp-context-set-brush-size brush-size) )
...
(script-fu-register "script-fu-zahnpasta-plus-logo"
                    "Zahnpasta PLUS..."
                    "zahnpasta logos"
...
(script-fu-menu-register "script-fu-zahnpasta-plus-logo"
