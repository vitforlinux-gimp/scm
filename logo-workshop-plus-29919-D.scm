...
(define (apply-logo-workshop-plus-299d19 img
                             logo-layer
                             fill-style
                             logo-color
			     logo-pattern
...
) ; return (from apply-logo-workshop-plus-299d19) 
;
;
...
;
(define (script-fu-logo-workshop-plus-299d-alpha img
                                       logo-layer
                                       fill-style
                                       logo-color
				       logo-pattern
...
;
    (apply-logo-workshop-plus-299d19 img logo-layer fill-style logo-color logo-pattern logo-gradient logo-grad-type logo-grad-dir logo-grad-rep logo-grad-rvs bevel-amt stroke-type stroke-color  stroke-pattern stroke-gradient stroke-grad-type stroke-grad-dir stroke-grad-rep stroke-grad-rvs stroke-width shadow-color shadowx shadowy shadow-opacity effect-style effect-pattern effect-depth alpha2logo)
...
;
(script-fu-register "script-fu-logo-workshop-plus-299d-alpha"
                    _"_Logo Workshop PLUS ALPHA 299 D..."
...
(script-fu-menu-register "script-fu-logo-workshop-plus-299d-alpha"
                         "<Image>/Filters/Alpha to Logo")

;
; Define logo effect text procedure
;
(define (script-fu-logo-workshop-plus-299d text
                                 size
                                 font 
								 justification
                                 letter-spacing
...
; Register the script
;    
(script-fu-register "script-fu-logo-workshop-plus-299d"
                    _"_Logo Workshop PLUS LOGO 299 D..."
...
(script-fu-menu-register "script-fu-logo-workshop-plus-299d"
