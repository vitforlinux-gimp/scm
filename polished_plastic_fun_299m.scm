...
(define list-fill-dir '("Color" "Pattern" "Gradient" "Carbon fiber" "Aluminium Brushed" "Aluminium Brushed Light" "Blue Jeans" "Dark Jeans" "Bovination 2.10 only" "Camouflage 2.10 only"  "Bovination 2.99" "Camouflage 2.99" "Plasma" "None"  "Patchwork" "Diffraction" "Pizza"))
...
(define 
	(
		script-fu-plastic-logo299m-alpha
		img
		text-layer
		border-color
		 border-size
	...
	(begin
		...
		(apply-plastic-logo-effect img text-layer border-color border-size shadow-color type blurred-fill color pattern gradient gradient-type direction ripple backtype fond-color back-pattern back-gradient back-gradient-type blendir)
...
(script-fu-register 	
	"script-fu-plastic-logo299m-alpha"
	"Polished Plastic Fun 299m alpha..."
