...
;    (if (= 2 gradmd) (gimp-edit-blend text-layer BLEND-CUSTOM LAYER-MODE-NORMAL-LEGACY 0 100 20 1 FALSE FALSE 0 0 FALSE 0 0 0 height))
    ...
    ((= foption 2)
       ...
       (gimp-drawable-edit-bucket-fill text-layer BUCKET-FILL-PATTERN  100 255 )
...
(script-fu-menu-register "script-fu-mhbevel3d" "<Image>/Script-Fu/Logos")
...
(begin
    ...
    (cond((= bg-md 1)
       ...
       (gimp-blend bg-layer BLEND-CUSTOM LAYER-MODE-NORMAL-LEGACY GRADIENT-LINEAR 100 20 REPEAT-NONE
                                            FALSE 0 0 0 0 0 0 width height))
       ((= bg-md 2)
       (gimp-selection-all img)
       (gimp-context-set-pattern bgpat)
       (gimp-drawable-edit-bucket-fill bg-layer BUCKET-FILL-PATTERN  100 255 )
       (gimp-selection-none img)
       ))
))
...
(script-fu-menu-register "script-fu-mhbevel3dimg22" "<Image>/Script-Fu/Alpha-to-Logo")
