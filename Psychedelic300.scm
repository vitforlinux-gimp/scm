...
; Rel 300 - 2024-12-15 Vitforlinux - works in 3.0 rc1 and 2.10 also compatibility = OFF
;
...
;
(define (script-fu-psychedelic300 image 
                        drawable
                        text-gradient
						mode
						bevel-size
...
(script-fu-register "script-fu-psychedelic300"        		    
  "Psychedelic 300 Alpha"
...
(script-fu-menu-register "script-fu-psychedelic300" "<Image>/Script-Fu/Alpha-to-Logo")

;
(define (script-fu-psychedelic300-logo 
                        text
						justify
						letter-spacing
						line-spacing
...
;;;;begin the script
	(script-fu-psychedelic300 image 
                        text-layer
                        text-gradient
						mode
						bevel-size
...
(script-fu-register "script-fu-psychedelic300-logo"
  "Psychedelic 300 LOGO"
  ...
  ;SF-ENUM "Paint Splatter LayerMode" '("LayerModeEffects" "layer-mode-hardlight-legacy")
  SF-ADJUSTMENT "Paint Splatter LayerMode" '(18 0 50 1 10 0 0)
  SF-ADJUSTMENT	"Bevel Size"			'(15 1 65 1 10 0 0)
...
(script-fu-menu-register "script-fu-psychedelic300-logo" "<Image>/Script-Fu/Logos")
;
;
;  
;
