...
;
(define (script-fu-logo-workshop300-alpha img
                                       logo-layer
                                       fill-style
                                       logo-color
                                       bevel-amt
...
;
(script-fu-register "script-fu-logo-workshop300-alpha"
                    _"_Logo Workshop Alpha 300..."
...
(script-fu-menu-register "script-fu-logo-workshop300-alpha"
                         "<Image>/Filters/Alpha to Logo")

;
; Define logo effect text procedure
;
(define (script-fu-logo-workshop300 text
                                 size
                                 font 
								 justification
                                 letter-spacing
...
; Register the script
;    
(script-fu-register "script-fu-logo-workshop300"
                    _"_Logo Workshop 300..."
...
(script-fu-menu-register "script-fu-logo-workshop300"
