...
(define (script-fu-lotr300-text   image
                               drawable
                               useColor
                               desiredColor
                               blendStyle
...
(script-fu-register "script-fu-lotr300-text"
"Lord of the Rings 300...Alpha"
...
(script-fu-menu-register "script-fu-lotr300-text" "<Image>/Script-Fu/Alpha-to-Logo/")
;;text
(define (script-fu-lotr300-text-text text size font justification letter-spacing line-spacing grow-text outline md color mgrad mtex blendStyle addShadow offsetX offsetY blurRadius shadowColor 
...
(script-fu-register "script-fu-lotr300-text-text"
		    "Lord of the Rings 300... Text"
...
(script-fu-menu-register "script-fu-lotr300-text-text" "<Image>/Script-Fu/Logos/")
